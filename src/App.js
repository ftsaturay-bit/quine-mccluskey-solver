  ...
  return (
    ...
    >
        ...
        <div className="w-full max-w-6xl flex flex-col items-center space-y-12">
          ...
          <div className="text-center space-y-6">
            ...
            <p className="max-w-2xl mx-auto text-lg md:text-xl text-slate-400 leading-relaxed font-medium">
              Simplify boolean expressions using the Quine-McCluskey tabulation
              method. Get precise, minimized results instantly.
            </p>
          </div>
      ...
      {output && results && (
        <section
          id="results"
          className="relative z-10 flex flex-col items-center px-4 py-24 border-t border-white/5 overflow-hidden"
        >
                    ...
                    <div className="flex flex-col items-center py-2">
                      <div className="flex items-center gap-6 mb-8">
                        <div className="relative">
                          <span className="text-6xl font-black text-orange-500/10 tabular-nums">
                            05
                          </span>
                        </div>
                        <div className="flex flex-col">
                          ...
                          <p className="text-[9px] uppercase tracking-[0.4em] font-bold text-slate-500 mt-1.5">
    ...
    <div className="relative">
      <StarBorder color="#f97316" speed="2.5s" thickness={4} className="w-full">
        <div className="flex items-center gap-6 mb-8">
          ...
          <h3 className="text-xl md:text-2xl font-black text-slate-300 uppercase tracking-widest">
            {title}
          </h3>
        </div>
        {children ? (
